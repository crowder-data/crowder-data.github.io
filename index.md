...
- Power BI (DAX, Power Query) - Microsoft PL-300 certified
- SQL (T-SQL)
- Data Modeling (OLTP, OLAP)
- Python (NumPy, Pandas, SciPy)
- Predictive & Prescriptive Analytics (Machine Learning & Simulations)
- Learning Microsoft Fabric - Planning for DP-600 exam
